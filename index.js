...
console.log(createMenuItem('Poke', 15, 'Lunch'));
...
function burgerDiscount(yes){
  if (yes === 'Teacher' || yes === 'Student'){
    return 13.5;
  }else{
    return 16.2;
  }
...
let newArr = [{name:"Jesus", rating: 8, feedback:"Hey everyone, Anthony Fantano, the internet's biggest music nerd"}];
reviews.push(...newArr);
console.log(reviews);
